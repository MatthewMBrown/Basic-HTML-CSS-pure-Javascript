function submitClick(){
    ...
    validation(name, surname, mobileNumber, emailAddress, selectedRace, isCitizen, isNotCitizen);
}
...
function validation(name, surname, mobileNumber, emailAddress, selectedRace, isCitizen, isNotCitizen){
     //Validation
